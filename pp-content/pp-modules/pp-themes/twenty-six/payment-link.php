        ...
        <div class="card card-md">
          <div class="card-body text-center py-3 p-sm-4">
            ...
            ?>
                    ...
                    <h2 class="mb-3 text-center"><?php echo $data['lang']['product_not_active']?></h2>

                    <p class="text-muted text-center"><?php echo $data['lang']['product_not_active_text']?></p>
            <?php
                }else{
            ?>
                    ...
                    <h1 class="mt-5"><?php echo $data['paymentLink']['product']['title'];?></h1>
                    <p class="text-secondary"><?php echo $data['paymentLink']['product']['description'];?></p>
                </div>
